...
// you should use getFrameBufferSize if you want the actual ammount of pixels to
// give to your opengl routines
glm::ivec2 getWindowSize();

inline int getWindowSizeX() { return getWindowSize().x; }
inline int getWindowSizeY() { return getWindowSize().y; }

// usually is the same as getWindowSize unless you have things like zoom or
// rezolution. You should use this function if you want to pass this data to
// glviewport
